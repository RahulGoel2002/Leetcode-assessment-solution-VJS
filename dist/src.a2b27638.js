...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/removeFormatting.js":[function(require,module,exports) {
var removeFormatting = function removeFormatting(inp) {
  var phn = "";
...
},{}],"src/formatPhone.js":[function(require,module,exports) {
var removeFormatting = require("./removeFormatting");
var formatPhone = function formatPhone(key, inp) {
  if (!isNaN(key)) {
    var pre = null,
      mid = null,
      post = null;
    var phn = removeFormatting(inp);
    pre = phn.slice(0, 3);
    if (!(phn.length < 4)) {
      pre = "(".concat(pre, ") ");
      mid = phn.slice(3, 6);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "41133" + '/');
